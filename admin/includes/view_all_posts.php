...
if(isset($_POST['checkBoxArray'])){
    ...
    case 'clone':
        ...
        $query= "INSERT INTO posts(post_category_id,post_title,post_another,post_user,post_date,post_image,
          post_content,post_tags,post_status)";

        $query .=  "VALUES('{$post_category_id}','{$post_title}','{$post_another}','{$post_user}',now(),
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <?php 
                                ...
                                echo "<td>$post_id </td>";
                        if(!empty($post_another)){
                            echo "<td>$post_another</td>";
